...
public class Path {
	...
	private void show() {
		...
		/*StdDraw.setPenColor(0,255,255);
		double[] x = { this.start.getLoc().getPos()[0],  (this.start.getLoc().getPos()[0]+this.end.getLoc().getPos()[0])/2-30,this.end.getLoc().getPos()[0], (this.start.getLoc().getPos()[0]+this.end.getLoc().getPos()[0])/2 };
